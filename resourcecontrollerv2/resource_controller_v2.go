...
/*
 * IBM OpenAPI SDK Code Generator Version: 99-SNAPSHOT-8a2d89a0-20220816-131234
 */
...
// PageLink : A link to a page of paginated results.
type PageLink struct {
	// The URL which links to the page of results.
...
type ResourceInstancesList struct {
	...
	// The number of resource instances in `resource_instances`.
	RowsCount *int64 `json:"rows_count" validate:"required"`
	...
	Next *PageLink `json:"next" validate:"required"`

	// OBSOLETE: The URL for requesting the next page of results.
	NextURL *string `json:"next_url" validate:"required"`
